...
import { UserPlus, Mail, ArrowLeft, MessageSquare } from "lucide-react";
        ...
        <DashboardLayout title="Team">
            ...
            <Tabs defaultValue="members">
                <TabsList className="mb-6 bg-white border border-gray-100 p-1 rounded-xl">
                    <TabsTrigger value="members" className="px-6 py-2 rounded-lg data-[state=active]:bg-primary data-[state=active]:text-white transition-all text-sm font-medium">
                        Members
                    </TabsTrigger>
